// JavaScript Document
	...
	$(document).ready(function() {
		...
		$('.navbar-nav li a'http://dsathemes.com/html/kolo/normal_register_form/js/).on('click', function() {				
		...
		$('#header a[href^="#"]'http://dsathemes.com/html/kolo/normal_register_form/js/).on('click', function (e) {
		...
		$.scrollUp = function (options) {
			...
			var defaults = {
				...
				scrollText: '', 5C/ Text for element0D0AscrollImg3A false, 5C/ Set true to use image0D0AactiveOverlay3A false 5C/ Set CSS color to display scrollUp active point, e.g '#00FFFF'
			};
