        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="text-align: right">
                        <span class="info-box-text">عدد النمازج المفعلة<br><br></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="text-align: right">
                        <span class="info-box-text">عدد النمازج الغير<br>مفعلة</span>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title pull-right">النمازج المضافة خلال سنة {{$year}}</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title pull-right">نمازج اضيفت مؤخرا</h3>

                        <div class="box-tools pull-right">
                            <span class="label label-danger">{{$active_buildings_count}} نموزج</span>
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>
                            </button>
                       ...
                       <?php $image = explode('|', $building->image) ?>
                                ...
                                <li class="item">
                                    <div class="product-img pull-right">
                                        <img src="@if($building->image != '') 
                                        building_images/{{$image[0]}} 
                                        @else 
                                        {{getSettings('no_image')}} 
                                        @endif"
                    ...
                    <!-- /.box-body -->
                    <div class="box-footer text-center">
                        <a href="{{url('adminpanel/building')}}">كل النمازج</a>
                    </div>
                    <!-- /.box-footer -->
                </div>
            </div>
