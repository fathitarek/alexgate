...
@else
    <link rel="stylesheet" href="{{ asset('home/css/style_ar.css') }}">
...
<div id="page-loader">
    <div class="page-loader__logo">
        <img id="logoo" src="{{ asset('home/images/uploads/logo_dark.png') }}" alt="ReaLand Logo">
        ...
        <div class="header__main">
            <div class="header__logo">
                <a href="{{URL('')}}">
                    ...
                    <img id="logoo" src="{{ asset('home/images/uploads/logo_dark.png') }}" alt="Realand">
                </a>
            </div><!-- .header__logo -->
            ...
            <div class="header__menu header__menu--v3">
                <ul class="header__nav">
                    <li class="header__nav-item @if(urldecode(Request::path())=='/') active @endif">
                        <a href="{{ URL('/') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.home')</a>
                    </li>

                    <li class="header__nav-item @if(urldecode(Request::path())=='المشروعات') active @endif">
                        <a href="{{ URL('المشروعات') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.projects') </a>
                    </li>
                    <li class="header__nav-item @if(urldecode(Request::path())=='الوحدات') active @endif">
                        <a href="{{ URL('الوحدات') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.units')</a>
                    </li>
                    <li class="header__nav-item @if(urldecode(Request::path())=='عنا') active @endif">
                        <a href="{{ URL('عن-الشركه') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.about')</a>
                    </li>
                    <li class="header__nav-item @if(urldecode(Request::path())=='اخر-الاخبار') active @endif">
                        <a href="{{ URL('اخر-الاخبار') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.blog') </a>
                    </li>
                    <li class="header__nav-item @if(urldecode(Request::path())=='اتصل-بنا') active @endif">
                        <a href="{{ URL('تواصل-معنا') }}" class="header__nav-link header__nav-link--v2 header__nav-link--mine-shaft">@lang('home.contact_us') </a>
                    </li>
                </ul><!-- .header__nav -->

                <ul class="topbar__user topbar__user--mine-shaft">
                    <li><a href="{{ URL('تسجيل') }}" class="topbar__link topbar__link--mine-shaft">@lang('home.sign_in') </a></li>
                    <li><a href="{{ URL('تسجيل') }}" class="topbar__link topbar__link--mine-shaft">@lang('home.Join')</a></li>
                    <li><select id="language_select">
            ...
            <a onclick="$(this).html(19999)" class="header__cta header__cta--outline">&plus; @lang ('home.hot_line')</a>
        </div><!-- .header__main -->
    </div><!-- .container -->
</header><!-- .header -->
    ...
    <div class="footer__main footer__main--v2">
        <div class="container">
            <div class="footer__logo">
                <h1 class="screen-reader-text">ReaLand</h1>
                <img id="logoo" src="{{ asset('home/images/uploads/logo.png') }}" alt="AlexGate">
            </div><!-- .footer__logo -->
            <p class="footer__desc">ReaLand is made for buying and selling houses faster, easier and customized for
                you.</p>
            <ul class="footer__social">
                @foreach(App\SiteSettings::whereBetween('id',[3,9])->get() as $item)
                     @if(!empty($item->value))
                        <li><a href="{{ $item->value }}"><i class="fa fa-{{ $item->name_setting }}" aria-hidden="true"></i></a></li>
                    @endif
                @endforeach
        ...
        <div class="container">
            <div class="footer__copyright-inner">
                <p class="footer__copyright-desc">
                    &copy; 2017 <span class="footer--highlighted-v2">ReaLand</span> Real Estate. All Right Reserved.
                </p>
...
<script src="{{ asset('home/js/googlemaps/v3-utility-library/master/infobox/src/infobox.js') }}"></script>
